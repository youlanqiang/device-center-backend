...
CREATE TABLE IF NOT EXISTS `dc_device`(
    ...
    fk_product_id bigint(64) unsigned not null comment '设备产品',
    fk_building_id bigint(64) unsigned comment '所属建筑',
    fk_floor_id bigint(64) unsigned comment '所属楼层',
    fk_zone_id bigint(64) unsigned comment '所属区域',
...
CREATE TABLE IF NOT EXISTS `dc_zone`(
    ...
    province_code mediumint unsigned comment '省份编码',
    city_code mediumint unsigned comment '城市编码',
    area_code mediumint unsigned comment '区域编码',
...
CREATE TABLE IF NOT EXISTS `dc_building`(
    ...
    fk_zone_id bigint(64) unsigned comment '关联园区id',
    province_code mediumint unsigned comment '省份编码',
    city_code mediumint unsigned comment '城市编码',
    area_code mediumint unsigned comment '区域编码',
    street_info varchar(255) comment '街道信息',
...
CREATE TABLE IF NOT EXISTS `dc_floor`(
    ...
    fk_building_id bigint(64) unsigned not null comment '关联建筑id',
    info varchar(255) comment '简介',
...
CREATE TABLE IF NOT EXISTS `dc_product_attribute`(
    fK_attribute_id bigint(64) unsigned comment  '属性id',
    fk_product_id bigint(64) unsigned comment  '产品id',
    primary key(fK_attribute_id, fk_product_id)
) comment = '设备模块-产品属性关联';

CREATE TABLE IF NOT EXISTS `dc_device_data`(
    fk_attribute_id bigint(64) unsigned comment '属性id',
    fk_device_id bigint(64) unsigned comment '设备id',
